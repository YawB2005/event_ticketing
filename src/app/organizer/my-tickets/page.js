...
import styles from '@/app/dashboard/tickets/MyTickets.module.css';

export default function OrganizerMyTicketsPage() {
        ...
        <div className={styles.ticketsGrid}>
          {tickets.map((ticket, idx) => (
            ...
            >
              ...
              <Link href={`/organizer/my-tickets/${ticket.id}`} className={styles.openBtn}>
                <QrCode size={18} /> 
