...
import styles from '@/app/dashboard/tickets/[ticketId]/TicketPass.module.css';

export default function OrganizerTicketPassPage({ params: paramsPromise }) {
  ...
  return (
    <div className={styles.page}>
      <Link href="/organizer/my-tickets" className={styles.backBtn}>
